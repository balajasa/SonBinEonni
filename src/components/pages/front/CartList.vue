    ...
    <div class="carList">
        ...
        <div class="container">
            ...
            <div class="row text-center p-5">
                <div class="col-md-3 alert alert-sborange alert-rounded">
                    確認購物車　　
                    <i class="fas fa-angle-double-right"></i>
                </div>
                <div class="col-md-3 alert alert-sbtan alert-rounded">填寫訂單資料</div>
                <div class="col-md-3 alert alert-sbtan alert-rounded" role="alert">確認訂單資料</div>
                <div class="col-md-3 alert alert-sbtan alert-rounded">完成訂購</div>
            </div>
            <div class="row mt-4">
                ...
                <div class="col-md-4 mb-6">
                    <div class="input-group">
                        <input type="text" class="form-control " v-model="coupon_code" placeholder="請輸入優惠碼:aniyo">
                        <div class="input-group-append">
                        <button type="button" class="btn btn-sbtan" @click="addCouponCode">確認</button>
                        </div>
                    </div>
            ...
            <div class="text-right mt-5 pb-5">
                ...
                <button type="submit" class="btn btn-sborange" @click.prevent="goNextPage">下一步</button>
            </div>
        </div>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-sborange confirm" data-dismiss="modal">確定</button>
                    </div>
                </div>
            </div>
        </div>
