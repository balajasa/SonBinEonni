        ...
        <div class="container">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb bg-transparent px-0 mb-3">
                    ...
                    <li class="breadcrumb-item">
                        <a class="text-sborange" @click.prevent="$router.push({ name: 'ProductList', params: { category: product.category }})">{{ product.category }}</a>
                    </li>
                ...
                <div class="col-6 col-md-6">
                    ...
                    <div class="row mt-4 align-items-end">
                        ...
                        <div class="col-sm-9 col-md-8">
                            <div class="btn-group border">
                                ...
                                <input type="number" class="input-qty btn btn-outline-sbtan" readonly v-model="productNum" @change="changeNumber(productNum, product.num)">
                                <button type="button" class="btn btn-outline-sbtan" @click="changeQty(1)">
                    ...
                    <div class="row mt-4 buyButton">
                        <div class="col-md-6 mt-3">
                            <button type="button" class="btn btn-sborange btn-block" @click.prevent="addtoCart(product.id, product.num),$router.push('/shopping/cartlist')">立即購買</button>
                        </div>
                        <div class="col-md-6 mt-3">
                            <button type="button" class="btn btn-sbinfo btn-block text-white" @click.prevent="addtoCart(product.id, product.num , productNum)">加入購物車</button>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="productItd">
                        ...
                        <div class="productContent p-3 my-4">
                            ...
                            <div class="row mt-4 p-3">
                                <div class="col-md-3">
                                    <div class="h4 text-sborange text-center font-weight-bold">自然界中健康的味道</div>
                                    <ul class="list-unstyled text-sbbrown py-3">
                                        <li><i class="far fa-smile-beam"></i> 選用有機的食材</li>
                                        <hr>
                                        <li><i class="far fa-smile-beam"></i> 無添加任何人工香料</li>
                                        <hr>
                                        <li><i class="far fa-smile-beam"></i> 立即下訂，歐尼主廚料理到你家</li>
                                    </ul>
                                </div>
                                <div class="col-md-9">
